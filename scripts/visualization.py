...
def create_comprehensive_dashboard_v4():
    ...
    # Metrik Finansial dari C++
    avg_return_rate = -0.003968 
    var_95_rate = -1.432583 / 100 
    ...
    # Slot Kanan Bawah Dibiarkan Kosong (ax_empty) untuk menjaga estetika dan keseimbangan tata letak
    ax_empty.axis('off')
